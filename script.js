// script.js
 ...
 btnAnimacion.addEventListener("click", () => {
    ...
    modalParagraph.textContent = "En la animación adjunta podemos observar el incremento de las muertes de pacientes por COVID-19 a lo largo de los años y, destaca en primer lugar, la región Metropolitana (la capital del país) superando con creces a las demás regiones por todo el período. En segundo lugar, la Región de Valparaíso y luego, en tercer lugar, la Región Del Bíobío que también hace lo suyo desde el año 2021 en adelante conservando este puesto hasta septiembre 2024 (fecha actualizada para este análisis). Además, podemos notar que los mayores casos, se concentran en las regiones correspondiente a la Zona Centro acumulando el 74.5% de las defunciones totales del país. Las regiones correspondientes a las zonas extremas (Norte y Sur) son las menos afectadas respecto a las de la Zona Central.";
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Barcklan cargado correctamente.');
